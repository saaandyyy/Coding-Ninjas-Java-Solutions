...
On substituting these values to the formula of totalSalary, we get Rs. 8761.53 and now rounding it
off will result in Rs. 8762 and hence the Answer.
...
public class TotalSalary {
	...
	public static void main(String[] args) {
		...
		if(ch=='A') {
			...
			double tss=Math.round(ts);
			int totalSalary=(int)(tss);
