...
Note :
If there are more than one rows/columns with maximum sum, consider the row/column that comes first. And if ith row and
jth column has the same largest sum, consider the ith row as answer.
Input Format :
...
public class LargestRowOrColumn {
	...
	public static void findLargest(int mat[][]) {
		...
		if(max_row_sum >= max_col_sum) {
			...
			System.out.println("col"+" "+max_col+" "+max_col_sum);
		}
	}
